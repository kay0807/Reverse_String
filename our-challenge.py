...
if __name__ == '__main__':
    ...
    user_name=raw_input("Enter name that needs to have a tally ")
    #returned_tally = count_letters(user_name)
    #returned_tally = count_letters_no_spaces(user_name)
    #returned_tally = count_letters_no_spaces_punctuation(user_name)
    returned_tally = count_letters_no_spaces_punctuation_case_sensitivity(user_name)
    for key,value in returned_tally.items():
        print key,value
